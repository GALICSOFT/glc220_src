...
//	LC_EXTERN void LCAPIENT glAlphaFuncx (GLenum, GLclampx);								¡æ glAlphaFunc
...
//	LC_EXTERN void LCAPIENT glClearColorx (GLclampx r, GLclampx g, GLclampx b, GLclampx a);	¡æ glClearColor
//	LC_EXTERN void LCAPIENT glClearDepthx (GLclampx depth);									¡æ glClearDepthf

	WINGDIAPI void APIENTRY glClearStencil (GLint s);
	LC_EXTERN void LCAPIENT glClientActiveTexture(GLenum texture);
//	LC_EXTERN void LCAPIENT glClipPlanex (GLenum plane, const GLfixed *equation);			¡æ glClipPlanef
	WINGDIAPI void APIENTRY glColor4ub (GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha);
//	LC_EXTERN void LCAPIENT glColor4x (GLfixed r, GLfixed g, GLfixed b, GLfixed a);			¡æ glColor4f
...
//	LC_EXTERN void LCAPIENT glDepthRangex (GLclampx nearValue, GLclampx farValue);			¡æ glDepthRangef
...
//	LC_EXTERN void LCAPIENT glFogx (GLenum pname, GLfixed param);							¡æ glFogf
//	LC_EXTERN void LCAPIENT glFogxv (GLenum pname, const GLfixed* params);					¡æ glFogfv
	WINGDIAPI void APIENTRY glFrontFace (GLenum mode);
//	LC_EXTERN void LCAPIENT glFrustumx (GLfixed,GLfixed,GLfixed,GLfixed,GLfixed,GLfixed);	¡æ glFrustumf
...
//	LC_EXTERN void LCAPIENT glGetClipPlanex (GLenum plane, GLfixed* equation);				¡æ glGetClipPlanef
	LC_EXTERN void LCAPIENT glGenBuffers (GLsizei n, GLuint* buffers);
	WINGDIAPI void APIENTRY glGenTextures (GLsizei n, GLuint *textures);
	WINGDIAPI GLenum APIENTRY glGetError (void);

//	LC_EXTERN void LCAPIENT glGetFixedv (GLenum pname, GLfixed* params);					¡æ glGetFloatv
	WINGDIAPI void APIENTRY glGetIntegerv (GLenum pname, GLint *params);
//	LC_EXTERN void LCAPIENT glGetLightxv (GLenum light, GLenum pname, GLfixed* params);		¡æ glGetLightfv

	WINGDIAPI void APIENTRY glGetPointerv (GLenum pname, GLvoid* *params);

	WINGDIAPI const GLubyte * APIENTRY glGetString (GLenum name);
	WINGDIAPI void APIENTRY glGetTexEnviv (GLenum target, GLenum pname, GLint *params);
//	LC_EXTERN void LCAPIENT glGetTexEnvxv (GLenum target, GLenum pname, GLfixed* params);	¡æ glGetTexEnvfv
	WINGDIAPI void APIENTRY glGetTexParameteriv (GLenum target, GLenum pname, GLint *params);
//	LC_EXTERN void LCAPIENT glGetTexParameterxv  (GLenum target, GLenum pname, GLfixed*);	¡æ glGetTexParameterfv

	WINGDIAPI void APIENTRY glHint (GLenum target, GLenum mode);
	LC_EXTERN GLboolean LCAPIENT glIsBuffer (GLuint buffer);
	WINGDIAPI GLboolean APIENTRY glIsEnabled (GLenum cap);
	WINGDIAPI GLboolean APIENTRY glIsTexture (GLuint texture);
//	LC_EXTERN void LCAPIENT glLightModelx (GLenum pname, GLfixed param);					¡æ glLightModelf

//	LC_EXTERN void LCAPIENT glLightModelxv (GLenum pname, const GLfixed* params);			¡æ glLightModelfv
//	LC_EXTERN void LCAPIENT glLightx (GLenum light, GLenum pname, GLfixed param);			¡æ glLightf
//	LC_EXTERN void LCAPIENT glLightxv (GLenum light, GLenum pname, const GLfixed* params);	¡æ glLightfv
//	LC_EXTERN void LCAPIENT glLineWidthx (GLfixed width);									¡æ glLineWidth
	WINGDIAPI void APIENTRY glLoadIdentity (void);

//	LC_EXTERN void LCAPIENT glLoadMatrixx (const GLfixed* m);								¡æ glLoadMatrixf
	WINGDIAPI void APIENTRY glLogicOp (GLenum opcode);
//	LC_EXTERN void LCAPIENT glMaterialx (GLenum face, GLenum pname, GLfixed param);			¡æ glMaterialf
//	LC_EXTERN void LCAPIENT glMaterialxv (GLenum face, GLenum pname, const GLfixed* );		¡æ glMaterialfv
	WINGDIAPI void APIENTRY glMatrixMode (GLenum mode);

//	LC_EXTERN void LCAPIENT glMultMatrixx (const GLfixed* m);								¡æ glMultMatrixf
//	LC_EXTERN void LCAPIENT glMultiTexCoord4x (GLenum, GLfixed, GLfixed, GLfixed, GLfixed);	¡æ glMultiTexCoord4f
//	LC_EXTERN void LCAPIENT glNormal3x (GLfixed x, GLfixed y, GLfixed z);					¡æ glNormal3f
	WINGDIAPI void APIENTRY glNormalPointer (GLenum type, GLsizei stride, const GLvoid *pointer);
//	LC_EXTERN void LCAPIENT glOrthox (GLfixed,GLfixed,GLfixed,GLfixed,GLfixed,GLfixed);		¡æ glOrthof

	WINGDIAPI void APIENTRY glPixelStorei (GLenum pname, GLint param);
//	LC_EXTERN void LCAPIENT glPointParameterx (GLenum pname, GLfixed params);				¡æ glPointParameterf
//	LC_EXTERN void LCAPIENT glPointParameterxv (GLenum pname, const GLfixed* params);		¡æ glPointParameterfv
//	LC_EXTERN void LCAPIENT glPointSizex (GLfixed size);									¡æ glPointSizef
//	LC_EXTERN void LCAPIENT glPolygonOffsetx (GLfixed factor, GLfixed units);				¡æ glPolygonOffsetf
...
//	LC_EXTERN void LCAPIENT glRotatex (GLfixed angle, GLfixed x, GLfixed y, GLfixed z);		¡æ glRotatef
	LC_EXTERN void LCAPIENT glSampleCoverage (GLclampf value, GLboolean invert);

//	LC_EXTERN void LCAPIENT glSampleCoveragex (GLclampx value, GLboolean invert);			¡æ glSampleCoverage
//	LC_EXTERN void LCAPIENT glScalex (GLfixed x, GLfixed y, GLfixed z);						¡æ glScalef
...
//	LC_EXTERN void LCAPIENT glTexEnvx (GLenum target, GLenum pname, GLfixed param);			¡æ glTexEnvf

	WINGDIAPI void APIENTRY glTexEnviv (GLenum target, GLenum pname, const GLint *params);
//	LC_EXTERN void LCAPIENT glTexEnvxv (GLenum target, GLenum pname, const GLfixed*);		¡æ glTexEnvfv
	WINGDIAPI void APIENTRY glTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
	WINGDIAPI void APIENTRY glTexParameteri (GLenum target, GLenum pname, GLint param);
//	LC_EXTERN void LCAPIENT glTexParameterx (GLenum target, GLenum pname, GLfixed param);	¡æ glTexParameterf

	WINGDIAPI void APIENTRY glTexParameteriv (GLenum target, GLenum pname, const GLint *params);
//	LC_EXTERN void LCAPIENT glTexParameterxv (GLenum target, GLenum pname, const GLfixed*);	¡æ glTexParameterfv
	WINGDIAPI void APIENTRY glTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
//	LC_EXTERN void LCAPIENT glTranslatex (GLfixed x, GLfixed y, GLfixed z);					¡æ glTranslatef
